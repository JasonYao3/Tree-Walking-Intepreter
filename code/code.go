...
func Make(op Opcode, opeprands ...int) []byte {
	...
	offset := 1
	// Iterate over the defined OperandWidths, take the matching element from operands and put it in the instruction
	for i, o := range opeprands {
